...
~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
<settings.py> Settings config for aruba_scan_api project.
...
Django settings for aruba_scan_api project.
...
ROOT_URLCONF = 'aruba_scan_api.urls'
...
WSGI_APPLICATION = 'aruba_scan_api.wsgi.application'
